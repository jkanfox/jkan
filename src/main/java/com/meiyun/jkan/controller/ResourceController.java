...
public class ResourceController {
    ...
    public String showAppendChildForm(@PathVariable("parentId") Long parentId, Model model) {
        MResource parent = resourceService.findOne(parentId);
        model.addAttribute("parent", parent);
        MResource child = new MResource();
    ...
    public String create(MResource resource, RedirectAttributes redirectAttributes) {
    ...
    public String update(MResource resource, RedirectAttributes redirectAttributes) {
